...
#! Working trivial sketch of the file encryption, the TODOs are listed below, probably this will only be finished by this summer.

# ? Idea: make an Encryption class, a FileIO class and a UI class.
# ?  Encryption object --(encr, decr)--> FileIO --(input, progress)--> UI  
